...
export default async function ManageEbooksPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-bold  tracking-tight">Manage All Ebooks</h1>
        <p className="text-sm text-slate-700">Approve new submissions, toggle availability, or remove listings.</p>
      </div>
