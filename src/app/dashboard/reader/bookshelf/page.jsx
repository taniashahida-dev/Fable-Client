    ...
    <div className="p-6  min-h-screen mt-10">
      ...
      <div className="flex items-center gap-3 mb-8 border-b border-[#EAE6DF] pb-4">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">Access and read all your purchased digital ebooks</p>
        </div>
      </div>
      ...
      {purchasedBooks.length === 0 ? (
        ...
        <div className="bg-white rounded-xl border border-[#EAE6DF] p-12 text-center max-w-xl mx-auto shadow-xs mt-10">
          ...
          <h3 className="text-lg font-serif font-semibold text-gray-800 mb-1">Your bookshelf is empty</h3>
          <p className="text-sm text-gray-500 mb-6">You haven`t purchased any premium ebooks yet. Start browsing our collection to fill your shelf!</p>
          <Link 
            href="/browse-books" 
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
          {purchasedBooks.map((book) => (
            ...
            >
              ...
              <div className="relative aspect-3/4 w-full bg-gray-100 border-b border-[#EAE6DF] overflow-hidden flex-shrink-0">
