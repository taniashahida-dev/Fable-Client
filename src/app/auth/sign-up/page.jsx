...
function SignupFormContent() {
  ...
  return (
    <div className="flex min-h-screen bg-linear-to-br from-slate-50 via-white to-violet-50 font-sans">
      {/* --- Left Side: Banner --- */}
      <div
        className="hidden lg:flex w-[45%] flex-col justify-between bg-linear-to-br
from-violet-700
via-indigo-700
to-slate-900 p-16 text-white relative overflow-hidden"
    ...
    <div className="absolute bottom-0 right-0 w-80 h-80 rounded-full bg-indigo-400/20 blur-3xl" />
        ...
        <div className="flex items-center gap-3 z-10">
          ...
          <span className="text-5xl font-agbalumo  font-bold tracking-tight">
            Fable
          </span>
        </div>
  ...
  <div className="flex items-center gap-3">
    ...
    <span className="text-3xl font-agbalumo text-slate-900">
      Fable
          ...
          <form className="flex flex-col gap-4 animate-in fade-in zoom-in-95 duration-500" onSubmit={handleSignup}>
            {error && (
...
"
          ...
          <div className="text-center text-sm font-medium text-slate-500">
            ...
            <Link
              ...
              className="font-bold text-[#4f46e5] text-sm hover:underline ml-0.5"
            >
              Log in
            </Link>
          </div>
...
export default function SignupPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen flex items-center justify-center bg-white text-sm text-slate-400 animate-pulse">
