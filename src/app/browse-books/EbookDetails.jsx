...
const EbookDetails = ({ bookData, currentUser, writer }) => {
  ...
  // Fallback state for missing book schema validation
  if (!bookData) {
    return (
  ...
  // Destructuring properties exactly mapping to your database document keys
  const {
    _id: id,
    title = "Untitled",
  ...
  return (
    <div className="py-12 mt-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-sm border border-[#EAE6DF] overflow-hidden p-6 md:p-10 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        {/* Left Side: Layout for Book Cover Artwork and Author Metadata */}
        ...
        {/* Right Side: Layout for Core Book Content Details & Payment Trigger */}
        <div className="md:col-span-2 flex flex-col justify-between space-y-6">
          <div>
            <div className="flex flex-wrap items-center gap-2 mb-4">
              ...
              <span className={`px-2.5 py-0.5 text-xs font-semibold rounded uppercase tracking-wider ${
            ...
            <p className="text-sm text-gray-500 mb-6">
              by <span className="text-[#1A4B58] font-medium">{writerName}</span>
            </p>
            ...
            <div className="bg-white border border-[#EAE6DF] rounded-lg p-5 mb-6 shadow-xs">
              ...
              {/* Dynamic rendering logic based on authorization criteria */}
              <div className="mt-4">
                {hasPurchased ? (
                  ...
                  <button disabled className="w-full bg-gray-200 text-gray-400 py-3 px-4 rounded-md font-medium text-sm cursor-not-allowed">
                  ...
                  >
                    {isProcessingPurchase ? 'Connecting to Stripe...' : 'Buy Now via Stripe'}
                  </button>
                )}
              </div>
            ...
            {/* Synopsis / Description Markdown Text Block */}
            <div className="mb-8">
          ...
          {/* Book Technical Metadata Grid Footer */}
          <div className="border-t border-[#EAE6DF] pt-6 grid grid-cols-3 gap-4 text-center">
            <div>
